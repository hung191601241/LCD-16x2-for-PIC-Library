...
void command(unsigned char a)
{
    {RB1=0; RB2=0;}
    PORTB=a;
    {RB3=1; _delay((unsigned long)((1)*(20000000/4000000.0))); RB3=0; _delay((unsigned long)((40)*(20000000/4000000.0)));}
}
...
void lcd_gotoxy(int x, int y)
{
    ...
    {
        case 1:
            lcd_command(0x80 + (y-1));
            break;
        case 2:
            lcd_command(0xC0 + (y-1));
            break;
        case 3:
            lcd_command(0x90 + (y-1));
            break;
        default:
            lcd_command(0xD0 + (y-1));
    }
}
